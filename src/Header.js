  ...
  return (
    <div className='header'>
        ...
        <div className='header_input'>
            ...
            type='text'
            />
              <SearchIcon onClick={handleSearch} className='header_inputButton'/>
        </div>
        ...
        <div className='header_icons'>
            ...
            <Avatar 
            alt=''
            src='https://yt3.googleusercontent.com/ytc/APkrFKZffQLw2Cqp2yh5r_URmGxvsUDvhy3XlT6Hmq4U5Q=s176-c-k-c0x00ffffff-no-rj'
            />
        </div>
    </div>
  );
